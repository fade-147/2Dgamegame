...
public class jichushuzhi : MonoBehaviour
{
    [Header("核心引用")]
    ...
    private Character character;     //角色的character脚本
    ...
    private void UpdateAttackDamage()
    {
        ...
        chongciPower.maxPower =100 + (talentLevel * attackPerLevel);
        character.maxHealth = 60 + (talentLevel * attackPerLevel);
    }
}
